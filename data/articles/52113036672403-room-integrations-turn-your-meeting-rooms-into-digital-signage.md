...
| --- | --- | --- |
| **Zoom Rooms** | Pushed automatically over Zoom's API | [Connect Zoom Rooms to OptiSigns](./52069065128723-connect-zoom-rooms-to-optisigns-digital-signage.md) |
| **Cisco Webex Rooms** | Pushed automatically over Webex's API | [Connect Cisco Webex Rooms to OptiSigns](./51343184586643-connect-cisco-webex-rooms-to-optisigns-digital-signage.md) |
| **Microsoft Teams Rooms** | Paste a signage URL (no push API) | [Connect Microsoft Teams Rooms to OptiSigns](./52350277262483-connect-microsoft-teams-rooms-to-optisigns-digital-signage.md) |
| **Google Meet hardware** | Paste a signage URL (no push API) | [Connect Google Meet Hardware to OptiSigns](./52412502456083-connect-google-meet-hardware-to-optisigns-digital-signage.md) |
...
- **[Connect Zoom Rooms →](./52069065128723-connect-zoom-rooms-to-optisigns-digital-signage.md)**
- **[Connect Cisco Webex Rooms →](./51343184586643-connect-cisco-webex-rooms-to-optisigns-digital-signage.md)**
- **[Connect Microsoft Teams Rooms →](./52350277262483-connect-microsoft-teams-rooms-to-optisigns-digital-signage.md)**
- **[Connect Google Meet Hardware →](./52412502456083-connect-google-meet-hardware-to-optisigns-digital-signage.md)**
...
- [Connect Zoom Rooms to OptiSigns](./52069065128723-connect-zoom-rooms-to-optisigns-digital-signage.md)
- [Connect Cisco Webex Rooms to OptiSigns](./51343184586643-connect-cisco-webex-rooms-to-optisigns-digital-signage.md)
- [Connect Microsoft Teams Rooms to OptiSigns](./52350277262483-connect-microsoft-teams-rooms-to-optisigns-digital-signage.md)
- [Connect Google Meet Hardware to OptiSigns](./52412502456083-connect-google-meet-hardware-to-optisigns-digital-signage.md)
