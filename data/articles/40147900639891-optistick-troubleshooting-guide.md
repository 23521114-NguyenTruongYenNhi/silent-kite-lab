...
By default, an OptiStick Player has an [**Operational Schedule**](./28598173096723-how-to-create-and-use-operational-schedules-hdmi-cec-rs-232.md) built in to ensure it has 8 hours of downtime per day:
...
OptiSigns Players also support the [**Mobile Admin App**](./30003143806099-how-to-use-the-optisigns-mobile-admin-app.md) as a Remote Control. This is our ***top recommendation,*** as not only does it function as a true remote control (allowing you to control your players from anywhere), but it has numerous other features as well.
...
- Check your firewall settings, and ensure you’ve [**Whitelisted OptiSigns IP addresses and ports**](./360047275934-whitelist-optisigns-ip-addresses-ports.md).
