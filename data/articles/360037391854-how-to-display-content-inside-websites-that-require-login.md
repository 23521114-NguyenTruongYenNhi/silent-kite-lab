...
You can also prefill a password in your URL for the Browser Popup case such as: [https://guest:guest@jigsaw.w3\.org/HTTP/Basic/](https://guest:guest@jigsaw.w3.org/HTTP/Basic/)
