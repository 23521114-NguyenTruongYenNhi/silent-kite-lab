...
1. (Optional, for Marketplace install) To fully revoke OptiSigns' Zoom access token, go to **marketplace.zoom.us Manage Added Apps OptiSigns Digital Signage Remove**.
